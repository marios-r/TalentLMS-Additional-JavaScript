$(function(){
	if($('#tl-branch-courses').length==1){
		...
		$(document).on('click', '.massaction',function(){
			...
			var url="branch/listcourse/id:"+branchid;
			$.ajax({
				dataType: "json",
				url: url,
